						...
						<form>
							<fieldset>
								...
								<div class="form-group">
									<input type="email" class="form-control" id="inputEmail1" placeholder="아이디 입력">
								</div>
								<div class="form-group">
									<input type="password" class="form-control" id="inputPassword1" placeholder="비밀번호 입력">
								</div>
								<button type="button" class="btn btn-primary btn-block" onclick ="location.href='main.html'">로그인
								</button>
							</fieldset>
						</form>
						<div style="font-weight: bold; color: #2E2E2E; text-align: center; margin-top: 30px;">
							<a class="a1" style="cursor: pointer" data-url="findId"><span>ID 찾기</span></a>
							<span> | </span>
