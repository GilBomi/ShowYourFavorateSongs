...
<body>
	<div id="wrap">
						...
						<div class="option">
							<div>
								<form onsubmit="searchPlaces(); return false;">
									키워드 : <input type="text" value="홍대 노래방" id="keyword" size="15">
		...
		<script type="text/javascript"
			src="//dapi.kakao.com/v2/maps/sdk.js?appkey=1b2a2b184271d601f05a300b5f7719ef&libraries=services"></script>
		<script>
			// 마커를 담을 배열입니다
			var markers = [];
