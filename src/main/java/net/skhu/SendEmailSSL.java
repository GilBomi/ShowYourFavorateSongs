...
public class SendEmailSSL { // 이메일 보내기 위해 만든 클래스
	final String username = ""; // 이메일을 보낼 계정 쓰기
	final String password = ""; // 이메일을 보낼 계정의 비밀번호 쓰기(실제 이메일,비밀번호 안쓰면 에러)
	Properties prop;
	...
	public void sendEmail(String toEmail,String auth_key) {
		...
		try {
			...
			message.setFrom(new InternetAddress("gmaru6420@gmail.com"));
	...
	//
	//        final String username = "gmaru6420@gmail.com";
	//        final String password = "a3641216";
	//
	...
	//            message.setRecipients(
	//                    Message.RecipientType.TO,
	//                    InternetAddress.parse("gmaru6420@gmail.com, gil1122@naver.com") // 받는 사람
	//            );
